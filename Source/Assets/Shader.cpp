/*
*  Shader.cpp authored by Chris Cascioli
*/
...
// --------------------------------------------------------
SimpleConstantBuffer* IShader::FindConstantBuffer(std::string name)
{
	// Look for the key
...
// --------------------------------------------------------
unsigned int IShader::FindTextureBindIndex(std::string name)
{
	// Look for the key
...
// --------------------------------------------------------
unsigned int IShader::FindSamplerBindIndex(std::string name)
{
	// Look for the key
	std::unordered_map<std::string, unsigned int>::iterator result =
...
// --------------------------------------------------------
void IShader::SetShader(bool copyData)
{
